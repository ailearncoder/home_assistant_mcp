    ...
    try:
        ...
        async with HAWebSocketClient(
            ...
            if "refresh_token" in token_info:
                ...
                logging.debug(f"Refresh token found: {refresh_token}")
                if _revoke_token(refresh_token):
                    logging.debug(f"Revoked refresh token: {refresh_token}")
...
def _revoke_token(refresh_token: str) -> bool:
    ...
    return auth.revoke_token(refresh_token)
